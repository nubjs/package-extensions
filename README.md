...
**780 package names.** The scan covers 9,982 of the top 10,000 and finds 649 with an undeclared dependency across 1,167 edges. The Yarn seed contributes 142 package names, including 131 not found by the scan.
...
| --- | --- | --- | --- |
| `types` | 534 | Only a `.d.ts` references it. No runtime edge at all. | optional peer |
