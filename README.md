...
**778 package names.** The scan covers 9,982 of the top 10,000 and finds 647 with an undeclared dependency across 1,160 edges. The Yarn seed contributes 142 package names, including 131 not found by the scan.
...
| `adapter` | 129 | A non-`.` exports subpath imports a backend the consumer chose. | optional peer |
